...
const MechanicLanding = () => (
  <Container maxWidth="md" sx={{ textAlign: 'center', mt: 8 }}>
    <Typography variant="h3" sx={{ mb: 2 }}>
      <span style={{ background: '#43a047', color: '#fff', padding: '0 12px', borderRadius: 4 }}>Hello,</span> Mechanic
    </Typography>
    ...
    <Divider sx={{ mb: 4 }} />
    <Typography sx={{ mb: 4 }}>
      Access your dashboard and manage service requests after Login.
    </Typography>
    <Box sx={{ mb: 4 }}>
      <Button
        variant="contained"
